...
import com.springboot.ckb.common.security.repository.MemRepository;
...
public class MemService {
    ...
    public List<Member> listMembers() throws DataAccessException {
    	   return memRepository.selectAllMemberList();
    }
    ...
    public Member findById(String memId) {
    	return memRepository.findById(memId)
    			.orElseThrow(()-> new IllegalArgumentException("Unexpected user"));
    }
    
    public Optional<Member> findByEmail(String email) {
    	return Optional.ofNullable(memRepository.findByEmail(email)); 
    }
}
