package com.springboot.ckb.common.log;
...
public class LoggingAdvice {
	...
	@Before("execution(* com.board01.*.service.*.*(..)) or "
	        + "execution(* com.board01.*.dao.*.*(..))")
	...
	@After("execution(* com.board01.*.service.*.*(..)) or "
	        + "execution(* com.board01.*.dao.*.*(..))")
	...
	@Around("execution(* com.board01.*.service.*.*(..)) or "
	        + "execution(* com.board01.*.dao.*.*(..))")
